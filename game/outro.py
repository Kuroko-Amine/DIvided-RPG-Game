...
if __name__ == "__main__":
    ...
    messages = ['La Fin.',
                'Notre groupe:',
                'Anis, Omar, Amine, Wael.',
                'J espere que vous avez apprecie jouer a ce jeu',
                'Vous avez commence en tant que petit enfant vivant avec son pere',
                'pour devenir un enfant qui pense que son pere est le vrai heros,',
                'Celui qui a sauve sa vie.',
                'Et n oubliez pas que nos decisions faconnent notre avenir.',
                'La confiance se gagne, et le respect se donne.',
                'Notre groupe a atteint son objectif !',
                '',
                '',
                'A bientot pour nos prochains jeux.',
                '',
                '',
                '',
                '',
    ...
    button1 = Button('Exit', 200, 40, (1050, 640), 5)
